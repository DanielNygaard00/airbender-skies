...
describe('the unlock table', () => {
  ...
  it('puts water and wall-riding in Act 2, and fire and the Avatar State in Act 3', () => {
    // Section 5's table, transcribed. Pinned as values rather than trusted to the comments in
    // `acts.ts`, so a retune of the table is a test change somebody has to justify.
