...
| Pressure Wave | up to 26 | **4.0** | Deliberately the smallest relative to its reach. The fiction is a shockwave travelling out across the surface, so it must not become a sphere as its radius grows with fall speed. |
| Vortex | up to 12 | **8.0** | The tallest, because lifting enemies off their feet is its whole payoff and the doc describes it as pulling inward and lifting. |
