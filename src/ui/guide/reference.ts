...
export const COMBOS: readonly Combo[] = [
  ...
  {
    // The pair the two borrowed elements were built to make: water buys the time, fire spends it.
    // Listed after the water combos because it only makes sense once the freeze does.
...
export const ELEMENT_LEGEND: Record<Element, string> = {
  ...
  fire: 'Damage, and the only element that has any worth the name — one burst hurts one soldier '
    + 'more than anything else you can aim. You get three charges, both fire moves spend one, and '
    + 'they only come back when you touch the ground: fire is a thing you spend, not a thing you '
    + 'hold. The narrowest reach in the game and the shortest above and below you, so you have to '
    + 'be close and level with what you are burning. Two steps clockwise from air, or 3.',
}
