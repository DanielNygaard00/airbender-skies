...
const player = (over: Partial<PlayerState> = {}): PlayerState => ({
  ...
  grounded: false, lastGroundIslandId: null, airJumpsUsed: 0, chargeTime: 0, scooterActive: false, scooterCharge: 0, dashesUsed: 0, dashRecovery: 0, slipstreamElapsed: null, slipstreamCooldown: 0, ...over,
})
